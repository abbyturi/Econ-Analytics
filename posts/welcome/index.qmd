...
## The Use of Models and Graphs in Economics
...
Source: Adapted from Silberberg, (2008)
...
## Concluding Remarks
While mathematical formulations lay a foundation for presenting economic problems, other mathematical and visualization issues arise in the communications of some of the core economic notions and theories. Some are overlooked, while some persist in misleading the target audience about the underlying economic issue. Wrapping up, while conventional presentations and norms in the field appear to be at ease to visualise economic problems, striking a balance between creativity and best practices ensures visualizations effectively convey their intended message. This should be with a due consideration that the core foundations of visual analytics remain in tact for an effective communication of economic problems.
